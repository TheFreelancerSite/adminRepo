          ...
          <div className="w-full border-stroke dark-border-strokedark xl-w-1/2 xl-border-l-2">
            <div className="w-full p-4 sm-p-12.5 xl-p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="w-full bg-primary text-white font-medium py-4 rounded-lg hover-bg-primary-dark active-bg-primary-darker focus-outline-none focus-visible-ring focus-visible-ring-primary"
                >
                  Sign In
                </button>
              </form>
